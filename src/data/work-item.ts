...
export default [
    ...
    },
    {
        ...
        description: [
            ...
            'Página de comemoração de aniversário.',
            'Gerador de url para equipe de reportagem'
        ],
        stack: [
            'React',
            'Wordpress',
    ...
    },
    {
        ...
        description: [
            ...
            'O que é?',
            'Através de um serviço online um monitor superviosiona um aluno através de uma camera, podendo até penaliza-lo e/ou expulsa-lo da prova caso necessário.'
        ],
        stack: [
            'Angular',
            'Node.js',
